namespace OpenCharas
{
	partial class UpdateForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "One or more updates have been found for OpenCharas. Would you like to update now?" +
    "";
			// 
			// button1
			// 
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(147, 102);
			...
			this.checkBox1.Text = "Don\'t automatically check";
